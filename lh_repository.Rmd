...
This repository contains life history information for species of fish, as entered by users of the TNC Size Limit Tradeoff Tool. These life histories can be used in the tool to estimate spawning potential ratio and fishing yield projected for size limit regulations. 
